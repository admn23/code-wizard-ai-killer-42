      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Understand complex code with detailed AI-powered explanations.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Provide enough surrounding code for better context
                  understanding
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Works with JavaScript, Python, Java, C++, and many other
                  languages
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Perfect for understanding complex algorithms and design
                  patterns
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Great for learning new frameworks, libraries, or coding
                  concepts
                </p>
              </div>
            </div>
