...
const SecurityChecker = () => {
  ...
  const handleSecurityCheck = async () => {
    ...
    try {
      ...
      const mockIssues: SecurityIssue[] = [
        {
          ...
          type: "SQL Injection",
          description:
            "Direct user input used in SQL query without sanitization",
          location:
      ...
      const randomIssues = mockIssues.slice(
        0,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <SEO
        ...
        description="Scan your code for security vulnerabilities and get AI-powered fixes and recommendations."
        canonical="/tools/security-checker"
      />
              ...
              {!checkCredits(2) && (
                <div className="flex items-center gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <span className="text-sm text-red-700">
                    Insufficient credits. You need 2 credits for security
                    analysis.
                  </span>
                </div>
              )}
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {securityIssues.length > 0 && (
                  <div className="flex items-center gap-2">
                    <Badge
                      className={`${securityScore >= 80 ? "bg-green-500" : securityScore >= 60 ? "bg-yellow-500" : "bg-red-500"}`}
                    >
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <Badge
                                  variant="outline"
                                  className={`text-xs ${issue.severity === "critical" ? "border-red-400" : issue.severity === "high" ? "border-red-300" : issue.severity === "medium" ? "border-yellow-400" : "border-blue-400"}`}
                                >
                              ...
                              <p className="text-xs font-mono bg-black/10 p-1 rounded mb-2">
                                {issue.location}
                              </p>
